...
### Иннотех `inno.tech`
> <sub>Декабрь 2019 - по наст.время (5+г)</sub>  
> **Ведущий разработчик команды контактного центра**
> ```
> на проекте:
> разработка: golang / docker,podman / postgres, redis, kafka / linux
> ci/cd: gitlab
> мониторинг/логирование: prometheus/elasticsearch
> ```

Проекты, задачи в роли ведущего разработчика команды платформенных сервисов:  
